...
const poolData = {
    UserPoolId: 'us-east-1_xxxxxxxxx', // Placeholder, dynamic injection from SAM normally
  ...
  const handleSubmit = (e) => {
    ...
    if (!isLogin) {
      ...
      userPool.signUp(formData.email, formData.password, attributeList, null, (err, result) => {
          ...
          alert('Sign up successful! Please check your email for verification link or proceed to login.');
          setIsLogin(true);
      });
    } else {
